...
- **Multiple skills**: Load process skills first (research, debugging) to determine HOW to approach the task; implementation skills second
...
1. **Read all mentioned files immediately and FULLY**:
   ...
   - **CRITICAL**: DO NOT spawn sub-tasks before reading these files
   - **ALWAYS** read files fully - if a file is mentioned, read it completely

2. **Spawn initial research tasks to gather context**:
   Before asking the user any questions, use specialized agents to research in parallel:
   - Use the **research-codebase** command to find all files related to the ticket/task
...
1. **Write the plan** to `plans/YYYY-MM-DD-ENG-XXXX-description.md`
